#  Payam Resan JAVA SMS API Examples

نمونه کدهای آماده JAVA برای اتصال به **وب‌سرویس پیامکی پیام‌رسان**  
...
در این ریپازیتوری، **نمونه‌کدهای JAVA برای استفاده از متدهای مختلف وب‌سرویس پیام‌رسان** قرار داده شده است. اگر توسعه‌دهنده JAVA هستید، می‌توانید به راحتی با این کدها، سامانه پیام‌رسان را به برنامه خود متصل کنید.
